...
## Purpose
Follow the presenter's voice through the active script with on-device speech recognition, highlighting what has been read and scrolling the overlay to the reading position.
## Requirements
